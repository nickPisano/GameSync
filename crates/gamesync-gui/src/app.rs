...
fn translucent_button_fills(ui: &mut egui::Ui) {
    ...
    for st in [&mut w.inactive, &mut w.hovered, &mut w.active] {
        ...
        st.weak_bg_fill = Color32::from_rgba_unmultiplied(c.r(), c.g(), c.b(), 20);
    }
}
...
fn title_with_badge(ui: &mut egui::Ui, name: &str, platform: &str) {
    ...
    // A glassy translucent colored pill: a very light fill that lets the card
    // show through, a soft tinted border, and a fully-rounded capsule shape.
